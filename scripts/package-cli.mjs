...
await writeFile(
  ...
  [
    ...
    "",
    "Cargo and Go find their dependencies only through an environment variable. IWOMC",
    "sets it for the proof command it runs and prints what to set in your own shell;",
    "it cannot change your shell for you.",
    "",
